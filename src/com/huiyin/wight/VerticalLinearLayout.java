...
public class VerticalLinearLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if(getChildAt(currentPage) instanceof ScrollView) {
            LogUtil.d("onInterceptTouchEvent","onInterceptTouchEvent:isScrollView");
            ScrollView o = (ScrollView) getChildAt(currentPage);
            View contentView = o.getChildAt(0);
            if (contentView != null
                    && contentView.getMeasuredHeight() <= o.getScrollY()
                    + o.getHeight()) {
                return true;
            }
        }
