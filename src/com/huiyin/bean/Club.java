...
public class Club {
	...
	private boolean isIntegralDecuc;//是否开启积分兑换抽奖    0可以  1不可以
	...
	public boolean isIntegralDecuc() {
		return isIntegralDecuc;
	}

	public void setIntegralDecuc(boolean isIntegralDecuc) {
		this.isIntegralDecuc = isIntegralDecuc;
	}
