...
public class GoodsDetailBeen extends BaseBean {
	 ...
	 * 去除"\u0000"的方法
	 */
	public void recodeCOMMODITY_IMAGE_LIST() {
		if (this.commodity != null && this.commodity.commodity != null
				&& !StringUtils.isBlank(this.commodity.commodity.COMMODITY_IMAGE_LIST)) {
			LogUtil.d("before", this.commodity.commodity.COMMODITY_IMAGE_LIST);
			this.commodity.commodity.COMMODITY_IMAGE_LIST = this.commodity.commodity.COMMODITY_IMAGE_LIST.replace("\u0000", "");
			LogUtil.d("after", this.commodity.commodity.COMMODITY_IMAGE_LIST);
