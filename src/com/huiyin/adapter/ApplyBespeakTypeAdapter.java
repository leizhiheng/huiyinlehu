 ...
 * 
 */
public class ApplyBespeakTypeAdapter extends BaseAdapter {
	...
	public ApplyBespeakTypeAdapter(Context context, List<ReservationType> goodsList) {
	...
	public void checkPosition(int position){
		if(position < getCount()){
			this.curCheckedTypeId = dataList.get(position).RESERVATIONTYP_ID;
			this.notifyDataSetChanged();
		}
	}
