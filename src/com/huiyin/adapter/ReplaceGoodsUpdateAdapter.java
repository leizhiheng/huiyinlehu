 ...
 * 
 */
public class ReplaceGoodsUpdateAdapter extends BaseAdapter {
	...
	public ReplaceGoodsUpdateAdapter(Context context, List<GoodsListEntity> dataList) {
	...
	class ViewHolder implements OnClickListener {
		...
		void show(GoodsListEntity GoodsListEntity, int position){
			...
			numberTv.setText(GoodsListEntity.getReplaceUpdateNumber()+"");
		...
		public void onClick(View arg0) {
			...
			case R.id.apply_add_imageview:
				...
				//加
				if(GoodsListEntity.addReplaceUpdate(1)){
					this.numberTv.setText(GoodsListEntity.getReplaceUpdateNumber()+"");
				}else{
					Toast.makeText(context, "亲！换货数不能超过"+GoodsListEntity.getQTY()+"哦", Toast.LENGTH_SHORT).show();
				}
