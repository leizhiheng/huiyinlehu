...
public class HouseKeeperOrderActivity extends BaseActivity {
	...
	public void showimage() {
		...
		case 40:
			...
			temp1.setImage(imageFile.getPath());
	...
	public void showimage(String path) {
		switch (photoFlag) {
		case 11:
			imageViewWithDel1.setImage(path);
			imageViewWithDel1.setVisibility(View.VISIBLE);
			countImage++;
			break;
		case 12:
			imageViewWithDel2.setImage(path);
			imageViewWithDel2.setVisibility(View.VISIBLE);
			countImage++;
			break;
		case 13:
			imageViewWithDel3.setImage(path);
			imageViewWithDel3.setVisibility(View.VISIBLE);
			countImage++;
			break;
		case 14:
			imageViewWithDel4.setImage(path);
			imageViewWithDel4.setVisibility(View.VISIBLE);
			countImage++;
			break;
		case 15:
			imageViewWithDel5.setImage(path);
			imageViewWithDel5.setVisibility(View.VISIBLE);
			countImage++;
			break;
		case 21:
			imageViewWithDel6.setImage(path);
			imageViewWithDel6.setVisibility(View.VISIBLE);
			fapiaoCountImage++;
			break;
		case 22:
			imageViewWithDel7.setImage(path);
			imageViewWithDel7.setVisibility(View.VISIBLE);
			fapiaoCountImage++;
			break;
		case 23:
			imageViewWithDel8.setImage(path);
			imageViewWithDel8.setVisibility(View.VISIBLE);
			fapiaoCountImage++;
			break;
		case 24:
			imageViewWithDel9.setImage(path);
			imageViewWithDel9.setVisibility(View.VISIBLE);
			fapiaoCountImage++;
			break;
		case 25:
			imageViewWithDel10.setImage(path);
			imageViewWithDel10.setVisibility(View.VISIBLE);
			fapiaoCountImage++;
			break;
		case 30:
	...
	private void makePoinment() {
		...
		RequstClient.houseKeepMakePointment(AppContext.userId, wisdom_id, name, phone, address,invoice_img, nameplate_img, 
