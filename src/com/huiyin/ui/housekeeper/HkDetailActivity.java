...
public class HkDetailActivity extends BaseActivity implements OnClickListener {
	...
	private String content, housekeeperId, housekeeperdeatilsTitle, introduction, ABSTRAC11, ABSTRAC22;
	...
	public void deatils() {
		...
		Intent i = getIntent();
		id = i.getStringExtra("id");
		RequstClient.houseKeeperDeatils(id, new CustomResponseHandler(this) {
			@Override
			public void onSuccess(int statusCode, Header[] headers, String content) {
				...
				try {
					...
					if (!obj.getString("type").equals("1")) {
						...
						Toast.makeText(HkDetailActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
						return;
					}
					mHK = new Gson().fromJson(content, HKDeatilBean.class);
