	...
	private void initView() {
		...
		order_comment.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent();
				i.setClass(MyOrderDetailActivity.this, OrderCommentActivity.class);
				i.putExtra("goodlist", mOrderDetailBean.orderDetail.orderDetailList);
				int flag = 0;
				// 评价
...
//					.priceForAppWithOutSign(g_item.COMMODITY_PRICE));
			...
			to_yuyue_tv.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent i = new Intent();
					i.setClass(MyOrderDetailActivity.this,ApplyBespeakActivity.class);
					i.putExtra(ApplyBespeakActivity.EXTRA_NUMBER,mOrderDetailBean.orderDetail.ORDER_CODE);
					startActivity(i);
					finish();
				}
			});
