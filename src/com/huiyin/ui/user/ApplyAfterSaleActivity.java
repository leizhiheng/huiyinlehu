...
//		 }
	...
	private void postBackGoodInfo(String name, String account, String phone) {
		...
		RequstClient.backGood(orderId, PAY_TYPE + "", reason, bank, branch_bank, name, account, phone, AppContext.userId, "1",
	...
	private void postChangeGoodInfo() {
		...
		RequstClient.changeGood(AppContext.userId, orderId, goodId, reason, receiver, phone, picUrl, "1", addr,
