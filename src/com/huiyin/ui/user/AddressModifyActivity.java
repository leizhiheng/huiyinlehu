...
public class AddressModifyActivity extends BaseActivity {
	...
	TextView address_modify_sure, address_modify_cancel, address_modify_addr_tip;
	...
	private void initView() {
		...
		address_modify_addr_tip = (TextView) findViewById(R.id.address_modify_addr_tip);
		setTextChangeListener(address_modify_addr, address_modify_addr_tip, 100);
