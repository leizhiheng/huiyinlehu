...
public class UploadImageLinearLayout extends LinearLayout {
    ...
    private AddPicOnClick mAddPicOnClick;
    ...
    private void initView() {
        ...
        add_pic.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(mAddPicOnClick!=null) {
                    mAddPicOnClick.OnAddClick();
                }
            }
        });
    ...
    public void addUrls(String url) {
        imgPathlist.add(url);
        setAddButtonVisiviblity(imgPathlist.size());
...
//    }
    ...
    public class GridAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ImageManager.Load("file://"+imgPathlist.get(position), viewHolder.image);
    ...
    public void setAddPicOnClick(AddPicOnClick mAddPicOnClick) {
        this.mAddPicOnClick = mAddPicOnClick;
    }
}
