...
public class OnLineMsgActivity extends BaseActivity {
	...
	private void initView() {
		...
		//右边图标不显示 对应bug 19355 add by liuyuanqi 20150618
	...
	private void makeMsg() {
		...
		RequstClient.postMsg(AppContext.userId, content, contact, type_id,
