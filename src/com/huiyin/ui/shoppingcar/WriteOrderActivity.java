...
public class WriteOrderActivity extends BaseActivity implements TextWatcher, OnClickListener {
	...
	private void setView() {
		...
		if (AppContext.userId == null) {
			...
			// 有用户登录
			RequstClient.writeOrderInit(AppContext.userId, shopId, new CustomResponseHandler(this) {
				@Override
	...
	private void postCommitInfo() {
		RequstClient.postCommitInfo(AppContext.userId, shopId, freight + "", jifen_value, jifen_num, "", addrId, payWayId,
	...
	public void onClick(View arg0) {
		...
		case R.id.write_hujuan_ed:
			if (listLehujuans != null && listLehujuans.size() > 0) {
				...
				hu_intent.putExtra(HuJuanDeductionActivity.INTENT_KEY_LIST,listLehujuans.toArray());
