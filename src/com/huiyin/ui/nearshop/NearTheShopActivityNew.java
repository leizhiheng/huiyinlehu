...
public class NearTheShopActivityNew extends Activity implements
    ...
    private void laodPageData(int loadType) {
        ...
        RequstClient.appNearbyStore(cityId, cityName.replaceAll("市", ""),
                mPageindex, lng, lat, handler);
    ...
    private void endUpData() {
        ...
        mXlistview.setRefreshTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
                .format(new Date()));
    }
    ...
    private void StartLoacation() {
        ...
        if (mLocationClient.isStarted()) {
            AppContext.getInstance().updateLocation();
            return;
        }
