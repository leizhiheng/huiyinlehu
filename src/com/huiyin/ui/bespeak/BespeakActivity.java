		...
		bespeak_listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.putExtra(ProductsDetailActivity.BUNDLE_KEY_GOODS_ID,
						bespeakListAdapter.getItem(arg2).GOODS_ID);
				intent.putExtra(ProductsDetailActivity.BUNDLE_KEY_subscribe_ID,
						Integer.parseInt(bespeakListAdapter.getItem(arg2).ID));
				intent.putExtra(ProductsDetailActivity.STORE_ID,
						bespeakListAdapter.getItem(arg2).STORE_ID+"");
				intent.putExtra(ProductsDetailActivity.GOODS_NO,
						bespeakListAdapter.getItem(arg2).GOODS_NO+"");
				...
				try {
					...
					if (obj.getInt("type") != 1) {
						...
						if (bespeakListBean != null
								&& bespeakListBean.goodsList != null
								&& bespeakListBean.goodsList.size() > 0) {

							bespeakListAdapter.addItem(bespeakListBean.goodsList,
									date);
							if (bespeakListBean.goodsList.size() < 10) {
								status = false;
