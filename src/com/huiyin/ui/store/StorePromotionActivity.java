 ...
 */
public class StorePromotionActivity extends Activity {
    ...
    private void loadPageData(int loadType) {
        ...
        RequstClient.storePromotion(handler, storeId, mPageindex);
