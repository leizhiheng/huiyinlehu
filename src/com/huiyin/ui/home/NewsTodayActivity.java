			...
			public void onRefreshData(String content) {
				...
				if (data.type == 1) {
					...
					if (!StringUtils.isBlank(data.headlines.IMAGE)) {
						ImageManager.LoadWithServer(URLs.IMAGE_URL + data.headlines.IMAGE, mImageView1, options,
                                NewsTodayActivity.this);
						isHas = true;
					}

					if (!StringUtils.isBlank(data.headlines.CONTENT)) {
                        ImageManager.LoadWithServer(URLs.IMAGE_URL + data.headlines.CONTENT, mImageView2, options,
								NewsTodayActivity.this);
						isHas = true;
					}
...
//		btnRight.setVisibility(View.GONE);
		...
		mListView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
				Intent intent = new Intent(getApplicationContext(), com.huiyin.ui.classic.ProductsDetailActivity.class);
