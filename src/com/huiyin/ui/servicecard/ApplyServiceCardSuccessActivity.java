...
public class ApplyServiceCardSuccessActivity extends Activity {
	...
	private void initData(){
		...
		RequstClient.appUpdateCardPwd(AppContext.getInstance().userId,AppContext.getInstance().mUserInfo.cardNum,oldpwdText,newpwdText, new CustomResponseHandler(this) {
			@Override
