...
public class ApplyServiceCard extends BaseActivity {
	...
	private void initView() {
		...
		mobile.setText(AppContext.getInstance().mUserInfo.phone);
	...
	private void initDatas(){
		...
		RequstClient.appApplyCard(AppContext.getInstance().userId,mobileText,codeText,nameText,idcodeText,addressText, new CustomResponseHandler(this) {
			@Override
			public void onSuccess(int statusCode, Header[] headers,
				...
				try {
					...
					if(obj.has("cardNum")){
						AppContext.getInstance().mUserInfo.cardNum= obj.getString("cardNum");
