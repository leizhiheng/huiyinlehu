// add by zhyao @2015/5/8  添加摇一摇说明界面
 ...
 * @author zhyao
 */
public class ShakeAboutActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title = getIntent().getStringExtra(ShakeActivity.INTENT_KEY_TITLE);
	...
	public void finish() {
		...
		intent.putExtra(ShakeActivity.INTENT_KEY_TITLE, title);
